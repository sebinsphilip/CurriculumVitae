...
\address{\faIcon{envelope} sebinsphilip@gmail.com\hspace{2ex}\faIcon{whatsapp} +49 1603084349\hspace{2ex}\faIcon{linkedin} linkedin.com/in/sebinsphilip/\hspace{2ex}\faIcon{globe} Germany}
%\address{123 Broadway \\ City, State 12345} % Main address
\address{Work Authorization: EU Blue Card holder (valid until 08/2029)}
...
%------------------------------------------------
    ...
    \begin{rSubsection}{Method Park by UL Solutions}{January 2025 - Present}{Software Engineer(Embedded Cyber Security), 1.1-year}{Erlangen, Germany}
    Working together with BMW Platform Security team for security hardening of next generation BMW cars running on Linux and Android. Took part in
    SELinux reviews for MAC (Mandatory Acceess Control), source code analysis and development in Google "vanir" (a static analysis tool for CVE scanning)
    for false positives, development of python-based tools and dockerized automation solutions for security-context creation.

    
    \end{rSubsection}

    \begin{rSubsection}{Università di Trento}{September 2023 - August 2024}{PhD Student (Wireless Sensor Networks), 1-year}{Trento, Italy}
